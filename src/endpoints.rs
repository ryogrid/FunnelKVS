...
//pub fn grpc__find_successor(self_node: &node_info::NodeInfo, id : u32) -> Result<node_info::NodeInfo, chord_util::GeneralError> {
pub fn grpc__find_successor(self_node: &node_info::NodeInfo, id : u32) -> node_info::NodeInfo {
...
// }
pub fn grpc__closest_preceding_finger(self_node: &node_info::NodeInfo, id : u32) -> node_info::NodeInfo {
